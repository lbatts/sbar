...
`obs.srep` is a matrix with parameters estimated from optimisation, as well as standard deviations of those parameters (estimated within TMB via the delta-method). There is also many other outputs of the assessment with associated error estimates given here. See function documentation and vignette for details. 
